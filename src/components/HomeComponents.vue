          ...
          <div class="col-md-4 mb-3 mb-md-0">
            <div class="card py-4 h-100">
              <div class="card-body text-center">
                ...
                <div class="small text-black-50">Marilia-SP</div>
              </div>
            </div>
          </div>
          ...
          <div class="col-md-4 mb-3 mb-md-0">
            <div class="card py-4 h-100">
              <div class="card-body text-center">
                ...
                <hr class="my-4 mx-auto" />
                <div class="small text-black-50">+55 (14) 4002-8922</div>
              </div>
            </div>
          </div>
        </div>
...
.masthead {
  ...
  min-height: 35rem;
  padding: 15rem 0;
  background: linear-gradient(to bottom, rgba(0, 0, 0, 0.3) 0%, rgba(0, 0, 0, 0.7) 75%, #000 100%), url("/src/assets/images/classmodel.png");
  background-position: center;
  background-repeat: no-repeat;
