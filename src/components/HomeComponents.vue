      ...
      <div class="container px-4 px-lg-5">
        ...
        <div class="row gx-0 mb-4 mb-lg-5 align-items-center">
          <div class="col-xl-8 col-lg-7">
            <img
              ...
              src="/src/assets/images/bg-masthead.jpg"
              alt="Masthead"
            />
          </div>
        ...
        <div class="row gx-0 mb-5 mb-lg-0 justify-content-center">
          <div class="col-lg-6">
            <img
              class="img-fluid"
              src="/src/assets/images/demo-image-01.jpg"
              alt="Project 1"
            />
          </div>
          <div class="col-lg-6">
        ...
        <div class="row gx-0 justify-content-center">
          <div class="col-lg-6">
            <img
              class="img-fluid"
              src="/src/assets/images/demo-image-02.jpg"
              alt="Project 2"
            />
          </div>
...
.masthead {
  ...
  min-height: 35rem;
  padding: 15rem 0;
  background: linear-gradient(to bottom, rgba(0, 0, 0, 0.3) 0%, rgba(0, 0, 0, 0.7) 75%, #000 100%), url("/src/assets/images/bg-masthead.jpg");
  background-position: center;
  background-repeat: no-repeat;
