    ...
    <div class="forms">
      <div class="cadastro">
        ...
        <form id="signupForm">
          ...
          <input type="text" id="sobrenome" placeholder="Digite aqui" required>
          <label for="emailCadastro">Email</label>
          <input type="email" id="emailCadastro" placeholder="Digite aqui" required>
          <label for="senhaCadastro">Senha</label>
          <input type="password" id="senhaCadastro" placeholder="Digite aqui" required>
          <label for="confirmarSenha">Confirme a senha</label>
          <input type="password" id="confirmarSenha" placeholder="Digite aqui" required>
